...
//	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
	...
	*/
	...
	'access_keys' => array('admin_panel', 'user'),
	...
	*/
	...
	'copy_cut_max_size'                       => 500,   //100
	// defines file count limit for paste / operation
	// set 'FALSE' for no limit
	'copy_cut_max_count'                      => 500,//200,
	...
	*******************/
	...
	#                          4 / crop = resize and crop;
	*/
	'fixed_image_creation_option'             => array(''), //set the type of the crop
	...
	'relative_image_creation_width'           => array(), //width of image (you can leave empty if you set height)
	...
	#                          4 / crop= resize and crop;
	*/
	'relative_image_creation_option'          => array(''), //set the type of the crop
