...
use Carbon\Carbon;
class HeadGroupEldwryStaticResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $prev_data=HeadGroupEldwryStatic::getGroupPrevSubeldwry($this->group_eldwry_id,$this->sub_eldwry_id,'sub_eldwry_id');
