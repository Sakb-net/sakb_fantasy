...
class CreateGroupEldwryTeamstaticsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('group_eldwry_teamstatics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('group_eldwry_teamstatics');
    }
}
