           ...
           <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0">
               ...
               <tr>
                   <td class="content-cell">
                       <h1 style="direction: rtl;font-weight: bold;font-size: 22px;color: #000000;letter-spacing: 0;text-align: right;">مرحبا بك معنا👋</h1>
                       <table class="subcopy" align="center" width="100%" cellpadding="0" cellspacing="0">
                           <tr>
                               <td>
                                   <p class="p-main" style="direction: rtl;font-weight: normal;text-align: justify;font-family: JannaLT;font-size: 16px;color: #4A4A4A;letter-spacing: 0;text-align: right;">{!!$message!!}</p>
