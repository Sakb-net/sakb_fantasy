...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-right">
              @if($comment_create > 0)
            <!--<a class="btn btn-success fa fa-plus" data-toggle="tooltip" data-placement="top" data-title="اضافة  " href="{{ route('admin.comments.create') }}"></a>-->
            ...
            @endif
            <a class="btn btn-primary fa fa-tasks" href="{{ route('admin.comments.index') }}"></a>
        </div>
