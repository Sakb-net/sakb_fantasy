...
<tr>
    ...
    <td>
        @if($comment_edit == 1)
        <a class="btn btn-info fa fa-commenting btn-user" data-toggle="tooltip" data-placement="top" data-title="{{trans('app.view')}}  {{trans('app.replaies')}}  " href="{{ route('admin.comments.show',$comment->id) }}"></a>
        <a class="btn btn-primary fa fa-edit btn-user" data-toggle="tooltip" data-placement="top" data-title="{{trans('app.update')}} " href="{{ route('admin.comments.edit',$comment->id) }}"></a>
        <a class="btn btn-success fa fa-plus btn-user" data-toggle="tooltip" data-placement="top" data-title="{{trans('app.add')}}  {{trans('app.replay')}} " href="{{ route('admin.comments.reply',$comment->id) }}"></a>
        @endif
