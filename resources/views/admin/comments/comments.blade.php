...
<tr>
    ...
    <td>
            @if($comment_edit == 1)
            <a class="btn btn-info fa fa-commenting" data-toggle="tooltip" data-placement="top" data-title="{{trans('app.view')}} " href="{{ route('admin.comments.show',$comment->id) }}"></a>
            <a class="btn btn-primary fa fa-edit" data-toggle="tooltip" data-placement="top" data-title=" {{trans('app.update')}} " href="{{ route('admin.comments.edit',$comment->id) }}"></a>
            <a class="btn btn-success fa fa-plus" data-toggle="tooltip" data-placement="top" data-title=" {{trans('app.repay')}} " href="{{ route('admin.comments.reply',$comment->id) }}"></a>
            @endif
