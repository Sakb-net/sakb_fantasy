...
@section('title') {{trans('app.eldwry')}}
@stop
...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-right">
            ...
            @endif
            <!-- <a class="btn btn-primary fa fa-search"  data-toggle="tooltip" data-placement="top" data-title="{{trans('app.search')}} {{trans('app.eldwry')}}" href="{{ route('admin.eldwry.search') }}"></a> -->
        </div>
    </div>
</div>
@stop
    ...
    <div class="col-sm-12">
        <div class="box">
            <div class="box-body">	
                ...
                <table id="eldwryTable" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th><center>ID</center></th>
                        <th><center>{{trans('app.name')}}</center></th>
                        <th><center>{{trans('app.price')}}</center></th>
   ...
   $(document).ready( function () {
    ...
    $('#eldwryTable').DataTable({
        ...
        $.ajax({
            ...
            var oTable = $('#eldwryTable').dataTable(); 
            oTable.fnDraw(false);
                console.log(data)
