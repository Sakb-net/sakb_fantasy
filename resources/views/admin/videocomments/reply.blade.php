...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-right">
            <a class="btn btn-success fa fa-comments" href="{{ route('admin.videocomments.index')}}"></a>
        </div>
    </div>
</div>
@stop
...
{!! Form::open(array('route' => ['admin.videocomments.reply.store',$id],'method'=>'post','data-parsley-validate'=>"")) !!}
<div class="row">
