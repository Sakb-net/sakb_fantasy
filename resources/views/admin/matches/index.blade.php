            ...
            @include('admin.errors.alerts')
                ...
                <thead>
                    <tr>
                        ...
                        <th><center>{{trans('app.round')}}</center></th>
                        <th><center>{{trans('app.firstTeam')}}</center></th>
                        <th><center>{{trans('app.secondTeam')}}</center></th>
                        <th><center>{{trans('app.dateOfMatch')}}</center></th>
                        <th><center>{{trans('app.matchTime')}}</center></th>
...
<script>
   $(document).ready( function () {
    ...
    $('#matchesTable').DataTable({
        ...
        ajax: "{{ route('admin.matches.list') }}",
        columns: [
            { data: 'id', name: 'id' },
            { data: 'name', name: "name"  },
            { data: 'subeldwryName', name: "subeldwryName"  },
            { data: 'firstTeam', name: 'firstTeam'  },
            { data: 'secondTeam', name: "secondTeam"  },
            { data: 'date', name: 'date'  },
            { data: 'time', name: "time"  },
        ...
        $.ajax({
            ...
            var oTable = $('#matchesTable').dataTable(); 
            oTable.fnDraw(false);
                console.log(data)
