...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-right">
            <a class="btn btn-success fa fa-comments" href="{{ route('admin.blogcomments.show',[$id]) }}"></a>
        </div>
    </div>
</div>
@stop
...
{!! Form::open(array('route' => ['admin.blogcomments.reply.store',$id],'method'=>'post','data-parsley-validate'=>"")) !!}
<div class="row">
    <div class="col-sm-9 col-md-9 col-lg-9">
        <div class="box">
            <div class="box-body">
                <div class="form-group">
                    <label>{{trans('app.comments')}}  :</label>
