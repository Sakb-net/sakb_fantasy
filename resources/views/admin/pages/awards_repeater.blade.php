<div class="box">
    <div class="box-body">
        <label> {{trans('app.awards')}} </label>
        <div class="clearfix m-b"></div>
        <div class="raw title-repeater">
            <div  data-repeater-list="titleaward" >
                ...
                <div  data-repeater-item>
                    ...
                    <div class="col-sm-10"> 
                        <label> {{trans('app.award_condition')}} :</label>
                        <!--,'id'=>'my-textarea'-->
        ...
        <div class="col-md-3 col-sm-4">
            <input  type="button" class="btn btn-success btn-s-xs title-add-show" value=" {{trans('app.add')}}   {{trans('app.award')}}"/>
        </div>

        <div class="clearfix"></div>
        <div class="raw title-add-repeater hide">
            <div  data-repeater-list="title_addaward" >
                <div  data-repeater-item>
                    <div class="col-sm-10"> 
                        <label> {{trans('app.title')}} :</label>
            ...
            <div class="col-md-3 col-sm-4 m-b">
                <input data-repeater-create type="button" class="btn btn-success btn-s-xs" value="{{trans('app.add')}}  {{trans('app.award')}}"/>
            </div>
        </div>
        </div>
