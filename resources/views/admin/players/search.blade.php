...
@section('title') {{trans('app.search')}} {{trans('app.players')}}
@stop
...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-right">
            ...
            @endif
            <a class="btn btn-primary fa fa-task"  data-toggle="tooltip" data-placement="top" data-title="{{trans('app.players')}} " href="{{ route('admin.players.index') }}"></a>
        </div>
    </div>
</div>
@stop
