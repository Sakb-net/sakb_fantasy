...
@stop
@section('content')
@include('admin.headGroupEldwry.models')
...
<script>
   $(document).ready( function () {
    ...
    $('#usersTable').DataTable({
        ...
        ajax:{
            url: "{{ route('admin.headGroupEldwry.listUsers')}}",
            data: {
                id:id,
        ...
        $.ajax({
            type: "post",
            url: "{{ route('admin.headGroupEldwry.setAdmin')}}",
            data: {
                id:modelId,
                adminId:adminId,
                _token: $('meta[name="_token"]').attr('content'),
        ...
        $.ajax({
            type: "post",
            url: "{{ route('admin.headGroupEldwry.activeUser')}}",
            data: {
                id:modelId,
                _token: $('meta[name="_token"]').attr('content'),
            },
    ...
    $('body').on('click', '#confirm-deactivate', function(){ 
        ...
        $.ajax({
            type: "post",
            url: "{{ route('admin.headGroupEldwry.disActiveUser')}}",
            data: {
                id:modelId,
                _token: $('meta[name="_token"]').attr('content'),
            },
    ...
    $('body').on('click', '#confirm-block', function(){ 
        ...
        $.ajax({
            type: "post",
            url: "{{ route('admin.headGroupEldwry.block')}}",
            data: {
                id:modelId,
                _token: $('meta[name="_token"]').attr('content'),
            },
    ...
    $('body').on('click', '#confirm-removeBlock', function(){ 
        ...
        $.ajax({
            type: "post",
            url: "{{ route('admin.headGroupEldwry.removeBlock')}}",
            data: {
                id:modelId,
                _token: $('meta[name="_token"]').attr('content'),
            },
