...
<tr>
    ...
    <td>
        ...
        <!--fa-eye-slash-->
        <!--<a class="btn btn-info fa fa-cube"  data-toggle="tooltip" data-placement="top" data-title="عرض الاقسام الفرعية" href="{{ route('admin.categories.show',$category->id) }}"></a>-->
        @endif
        @if($category_edit == 1)
        <a class="btn btn-primary fa fa-edit"  data-toggle="tooltip" data-placement="top" data-title=" تعديل" href="{{ route('admin.categories.edit',$category->id) }}"></a>
        @endif
