...
@section('title') {{trans('app.search')}}  {{trans('app.ranking_eldwry')}}
@stop
...
<div class="row">
    ...
    <div class="col-lg-12 margin-tb">
        <div class="pull-right">
            ...
            @endif
            <a class="btn btn-primary fa fa-task"  data-toggle="tooltip" data-placement="top" data-title="{{trans('app.ranking_eldwry')}}" href="{{ route('admin.ranking_eldwry.index') }}"></a>
        </div>
