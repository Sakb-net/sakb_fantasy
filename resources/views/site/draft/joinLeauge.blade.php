...
<section class="section-padding mainSection">
    ...
    <section class="section-padding joinLeauge wow fadeInUp">
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3>{{trans('app.joinPrivateLeague')}}</h3>
                        </div>
                            ...
                            <form id="joinLeauge" method="post">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans(app.leagueCode)}}</label>
                                        <input type="text" id="code" name="dawryCode" class="form-control" required placeholder="{{trans(app.eldwryCode)}}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
...
@section('after_foot')
<script src="{{ asset('js/site/draft/joinLeauge.js?v='.config('version.version_script')) }}') }}"></script>
@stop