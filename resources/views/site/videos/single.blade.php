...
@section('content')
<div class="myinner-banner best-teamimg  videos-banner">
    <div class="opacity opcit-teamimg opcit-videos" @if(isset($team_image_fav) && !empty($team_image_fav) ) style="background-image: url({{$team_image_fav}}) !important;" @endif>
        <ul>
            <li><a href="{{ route('home') }}">{{trans('app.Home')}}</a></li>
            <li>/</li>
            <li><a href="{{ route('videos.index') }}">{{trans('app.videos')}}</a></li>
        </ul>
