<form id="player-select" novalidate="novalidate">
    <div class="form-group ">
        <label class="control-label">{{trans('app.show_according')}} :</label>
        <select class="form-control filter_playersTeamsTransformation" id="filter_playersTeamsTransformation">
...
<!--    الافتراضي        <optgroup label="الموقع">
    ...
    <div class="form-group ">
        ...
        <select class="form-control order_playersTeamsTransformation" id="order_playersTeamsTransformation">
